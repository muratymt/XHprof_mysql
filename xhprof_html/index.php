...
$params = [
    'run' => [XHProfLib::XHPROF_STRING_PARAM, ''],
    'wts' => [XHProfLib::XHPROF_STRING_PARAM, ''],
    'symbol' => [XHProfLib::XHPROF_STRING_PARAM, ''],
    'sort' => [XHProfLib::XHPROF_STRING_PARAM, 'wt'], // wall time
    'run1' => [XHProfLib::XHPROF_STRING_PARAM, ''],
